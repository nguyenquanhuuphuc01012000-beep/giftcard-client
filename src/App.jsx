    ...
    <div className="w-full min-h-screen flex flex-col items-center justify-start text-white overflow-x-hidden relative">
      ...
      <div className="marquee-container">
        <div className="marquee-content">
          04/11/2025 Lỗ hổng nền tảng thương mại điện tử: thách thức cho doanh nghiệp Việt Nam. Lỗ hổng nghiêm trọng trên nền tảng thương mại điện tử Magento (Adobe Commerce) đang đe dọa các doanh nghiệp tại Việt Nam. Lỗ hổng có tên Session Reaper cho phép tin tặc khai thác phiên đăng nhập của người dùng để thực thi mã độc và chiếm quyền điều khiển hệ thống. Hàng nghìn máy chủ Magento trên toàn cầu, bao gồm nhiều cửa hàng thương mại điện tử tại Việt Nam, vẫn chưa được cập nhật bản vá khẩn cấp, tạo cơ hội cho các cuộc tấn công tự động. Các chuyên gia bảo mật khuyến nghị doanh nghiệp nên nhanh chóng cập nhật bản vá từ Adobe và kích hoạt tường lửa ứng dụng web (WAF) để bảo vệ hệ thống, đồng thời kiểm tra các tài khoản quản trị và tệp lạ để tránh rủi ro.
        </div>
      </div>
      {/* 🧊 Nền động hologram */}
      <div className="cubes">
